        ...
        favoriteImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(flag==0){
                    ...
                    //bookmark_table_item_index = (new NewsDbHelper(context)).numberOfRowsInBookmarks();
                    //Log.e(" BEFORE TechHolder: ", String.valueOf(bookmark_table_item_index));
                    //bookmark_table_item_index++;
                    //Log.e(" AFTER TechHolder: ", String.valueOf(bookmark_table_item_index));
