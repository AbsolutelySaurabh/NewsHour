...
public class HeadlinesDbHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "headlineNews";
    ...
    public boolean insertNews(String title, String desc, String url, String url_to_image, String publishedAt, int isBookmarked) {
    ...
    public boolean updateNews(Integer id, String title, String desc, String url, String url_to_image,
