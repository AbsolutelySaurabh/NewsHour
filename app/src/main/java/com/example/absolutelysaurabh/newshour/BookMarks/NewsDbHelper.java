...
//        return db.delete(TABLE_NAME_HEAD, COLUMN_ID + " = ? ", new String[] { Integer.toString(position) });
...
//        db.execSQL("UPDATE " + TABLE_NAME_BOOKMARK + " SET " + COLUMN_ID + " = " +
//                COLUMN_ID + " -1 " + " WHERE " + COLUMN_ID + " > " + position + ";");
